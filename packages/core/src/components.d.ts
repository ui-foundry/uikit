...
declare global {
    ...
    interface HTMLUkAlertElement extends Components.UkAlert, HTMLStencilElement {
        addEventListener<K extends keyof HTMLUkAlertElementEventMap>(
            type: K,
            listener: (this: HTMLUkAlertElement, ev: UkAlertCustomEvent<HTMLUkAlertElementEventMap[K]>) => any,
        ...
        removeEventListener<K extends keyof HTMLUkAlertElementEventMap>(
            type: K,
            listener: (this: HTMLUkAlertElement, ev: UkAlertCustomEvent<HTMLUkAlertElementEventMap[K]>) => any,
