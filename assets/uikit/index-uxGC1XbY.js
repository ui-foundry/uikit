...
const BUILD = /* uikit */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, asyncQueue: false, attachStyles: true, cloneNodeFix: false, constructableCSS: false, cssAnnotations: true, devTools: true, element: false, event: false, experimentalScopedSlotChanges: false, experimentalSlotFixes: false, formAssociated: false, hasRenderFn: true, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: true, hydrateClientSide: false, hydrateServerSide: false, hydratedAttribute: false, hydratedClass: true, hydratedSelectorName: "hydrated", initializeNextTick: false, invisiblePrehydration: true, isDebug: false, isDev: true, isTesting: false, lazyLoad: true, lifecycle: false, lifecycleDOMEvents: false, member: true, method: false, mode: false, modernPropertyDecls: true, observeAttribute: true, profile: true, prop: true, propBoolean: false, propMutable: false, propNumber: true, propString: true, reflect: false, scoped: false, scopedSlotTextContentFix: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: true, slot: true, slotChildNodesFix: false, slotRelocation: true, state: true, style: true, svg: false, taskQueue: true, transformTagName: false, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: false, vdomKey: true, vdomListener: true, vdomPropOrAttr: true, vdomRef: false, vdomRender: true, vdomStyle: true, vdomText: true, vdomXlink: false, watchCallback: false };
const Env = /* uikit */ {};

const globalScripts = () => {};
const globalStyles = ":root{--spacing: 4px;--grid-columns: 16;--font-size-base: calc(var(--spacing) * 4);--font-family: system-ui, sans-serif;--font-weight-regular: 400;--font-weight-bold: 700;--screen-xs: 576px;--screen-sm: 768px;--screen-md: 992px;--screen-lg: 1200px;--screen-xlg: 1440px;--screen-fhd: 1920px;--screen-2k: 2048px;--screen-4k: 3840px;--screen-max-container: 1136px;--radius-sm: var(--spacing);--radius-md: calc(var(--spacing) * 2);--radius-lg: calc(var(--spacing) * 3);--radius-full: 50%;--radius-pill: 9999px}*:where(:not(html,iframe,canvas,img,svg,video,audio):not(svg *,symbol *)){all:unset;display:revert}*,*::before,*::after{-webkit-box-sizing:border-box;box-sizing:border-box}html{-moz-text-size-adjust:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;text-size-adjust:none}a,button{cursor:revert}ol,ul,menu,summary{list-style:none}ol{counter-reset:revert}img{max-inline-size:100%;max-block-size:100%}table{border-collapse:collapse}input,textarea{-webkit-user-select:auto}textarea{white-space:revert}meter{-webkit-appearance:revert;-moz-appearance:revert;appearance:revert}:where(pre){all:revert;-webkit-box-sizing:border-box;box-sizing:border-box}::-webkit-input-placeholder{color:unset}::-moz-placeholder{color:unset}:-ms-input-placeholder{color:unset}::-ms-input-placeholder{color:unset}::placeholder{color:unset}:where([hidden]){display:none}:where([contenteditable]:not([contenteditable=false])){-moz-user-modify:read-write;-webkit-user-modify:read-write;overflow-wrap:break-word;-webkit-line-break:after-white-space;-webkit-user-select:auto}:where([draggable=true]){-webkit-user-drag:element}:where(dialog:modal){all:revert;-webkit-box-sizing:border-box;box-sizing:border-box}::-webkit-details-marker{display:none}*{-webkit-box-sizing:border-box;box-sizing:border-box}body{font-family:var(--font-family);font-size:var(--font-size-base);text-rendering:optimizeLegibility;background:#1a1a1e;line-height:1.6;color:#e8e8ec;font-weight:var(--font-weight-regular)}.uk-d-inline{display:inline}.uk-d-inline-block{display:inline-block}.uk-d-block{display:block}.uk-d-grid{display:grid}.uk-d-inline-grid{display:inline-grid}.uk-d-table{display:table}.uk-d-table-row{display:table-row}.uk-d-table-cell{display:table-cell}.uk-d-flex{display:-webkit-box;display:-ms-flexbox;display:flex}.uk-d-inline-flex{display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex}.uk-d-none{display:none}.uk-flex-auto{-webkit-box-flex:1;-ms-flex:1 1 auto;flex:1 1 auto}.uk-flex-initial{-webkit-box-flex:0;-ms-flex:0 1 auto;flex:0 1 auto}.uk-flex-none{-webkit-box-flex:0;-ms-flex:none;flex:none}.uk-flex-1{-webkit-box-flex:1;-ms-flex:1;flex:1}.uk-flex-row{-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row}.uk-flex-col{-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}";
        ...
        if (!hmrVersionId || !BUILD.hotModuleReplacement) {
          ...
          switch(bundleId) {
                ...
                case 'uk-alert':
                    return import(
                      /* webpackMode: "lazy" */
                      './uk-alert.entry.js').then(processMod, consoleError);
                case 'uk-avatar':
                    return import(
                      /* webpackMode: "lazy" */
                      './uk-avatar.entry.js').then(processMod, consoleError);
          }
      }
  return import(
    /* @vite-ignore */
...
//# sourceMappingURL=index-uxGC1XbY.js.map
